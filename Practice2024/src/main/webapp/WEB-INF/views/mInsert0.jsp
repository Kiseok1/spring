  ...
  <form method="post" action="">
   <div class="container">
    <div class="insert">
	    ...
	    <tr>
	    	  <td class="col1" rowspan="5"><div style="width: 150px; height: 200px; border: 1px solid black; margin: 0 auto;"></div></td>
	    </tr>
	    <tr>
	        
	        <td class="col2">이&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp름 <input type="text" name="name" maxlength="5"></td>
	    </tr>
	    <tr>
	        
	        <td class="col2">아&nbsp&nbsp&nbsp&nbsp이&nbsp&nbsp&nbsp&nbsp디
	    ...
	    <tr>
	        ...
	        <td class="col2">비&nbsp&nbsp밀&nbsp&nbsp번&nbsp&nbsp호
	    ...
	    <tr>
	        ...
	        <td class="col2">비밀번호 확인 <input type="password" name="pwdCheck" maxlength="16"></td>
	    </tr>
	    <tr>
