   ...
   <div class="container">
    <div class="insert">
	    ...
	    <tr>
	    	...
	    	<div style="width: 150px; height: 200px; border: 1px solid black; margin: 0 auto;"></div>
	    	<label for="file" style=" display: flex; justify-content: center; align-items: center; margin-top: 10px;"><span style="border: 1px solid black; width: 65px; text-align: center;">파일선택</span></label>
	    ...
	    <tr>
	        ...
	        <td class="col2"><input type="password" name="pwdCheck" maxlength="16"><strong id="pwchkMsg" style="font-size: 11px; margin-left: 8px;">※비밀번호를 확인해주세요.</strong></td>
	    </tr>
	    <!-- <tr>
	        <td class="col1">프로필 사진 등록</td>
	        <td class="col2" colspan="2"><input type="file"></td>
	    </tr> -->
	    <tr>
	    ...
	    <tr>
	        ...
	        <td class="col2" colspan="2">
	            ...
	            <input type="text" name="email" style="width: 100%; margin-top: 2px;">
	        </td>
	    </tr>
    </table>
