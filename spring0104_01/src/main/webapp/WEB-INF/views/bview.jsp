...
<html>
	<head>
		...
		<script>
		   function deleteBtn(){
			   if(confirm("게시글을 삭제하시겠습니까?")) location.href="doFboardDelete.do?bno=${bdto.bno}&page=${page}&searchTitle=${searchTitle}&searchWord=${searchWord}";
		   }
		   function updateBtn(){
			   if(confirm("게시글을 수정하시겠습니까?")) location.href="fboardUpdate.do?bno=${bdto.bno}&page=${page}&searchTitle=${searchTitle}&searchWord=${searchWord}";
		   }
		</script>
	</head>
	<body>
