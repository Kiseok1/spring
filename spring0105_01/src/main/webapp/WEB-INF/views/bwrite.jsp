...
<head>
  ...
  <script>
  	...
  	function uploadImage(file,this_location){
  		var fdata = new FormData(); //ajax에서 전송할 때 form형태로 전송
  		...
  		$.ajax({
  			...
  			type:"post",
  			data:fdata,
  			dataType:"text",   //받는 형태 - text,json,xml.... 
  			cashe:false,	   //남아 있는 데이터 정보 새롭게 정리
  			contentType:false, //보내는 형태 - default값 : application/x-www-form-urlencoded
  			processData:false, //query String 형태로 보내지 않음. (query String 형태 예 http://localhost:8000/bno=1)
  			enctype:"multipart/form-data",
  			success:function(data){ //서버에 가서 이미지를 저장후 파일이름과 저장위치를 리턴
  				//data : /upload/190023423123_1.jpg
