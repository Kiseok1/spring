...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=a1f1f9b7f265c07ea9bf9efb719ec2d1&redirect_uri=http://localhost:8000/kakao/oauth">
      	<li class="kakao"></li>
      </a>
      <li class="naver"></li>
