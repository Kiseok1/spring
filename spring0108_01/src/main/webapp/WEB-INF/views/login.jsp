...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=1a2cbf452556c950c1cfd918d43f52f8&redirect_uri=http://localhost:8000/kakao/oauth">
      	<li class="kakao"></li>
      </a>
      <li class="naver"></li>
