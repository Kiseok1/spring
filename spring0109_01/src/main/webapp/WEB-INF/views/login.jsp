...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=372e1e99bb3b540f6d9b77dbd77173ef&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code" style="text-decoration: none;">
      	<li class="kakao"></li>
      </a>
      <li class="naver"></li>
