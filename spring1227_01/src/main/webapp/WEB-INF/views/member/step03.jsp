					...
					<script>
						$(function(){
							...
							$(".nbtnMini").click(function(){
								let id = $("#id").val();
								//alert(id);
								/* let idPtn = /^[a-z]{1}[a-zA-Z0-9_]{2,15}$/
								if(!idPtn.test(id)){
									alert("조건에 부합되지 않는 아이디입니다.");
									return false;
								}  */
						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<form action="/member/step04" name="frm" method="post">
								...
								<tr>
									...
									<td><input type="text" id="name" name="name" class="w134" /></td>
								</tr>
								<tr>
									...
									<td>
										<ul class="pta">
											<li>
												<ul class="baseQues">
													<li>
														<input type="checkbox" name="hobby" id="game" value="game" class="radio_t" /><label for="game">game</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="golf" value="golf" class="radio_t"/><label for="golf">golf</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="run" value="run" class="radio_t"/><label for="run">run</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="book" value="book" class="radio_t"/><label for="book">book</label>
													</li>
													<li>
														<input type="checkbox" name="hobby" id="cook" value="cook" class="radio_t"/><label for="cook">cook</label>
													</li>
												</ul>
											</li>
										</ul>
