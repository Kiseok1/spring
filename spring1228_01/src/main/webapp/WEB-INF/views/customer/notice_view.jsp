				...
				<div id="customer">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							<div class="subject">
								<ul>
									<li>${map.ndto.btitle}</li>
								</ul>
							</div>
							<div class="day">
								<p class="txt">작성일<span><fmt:formatDate value="${map.ndto.bdate}" pattern="yy.MM.dd"/></span></p>
							</div>
						</div>

						<div class="viewContents">${map.ndto.bcontent}</div>
						<div><img src="/upload/${map.ndto.bfile}"></div>
					</div>
						...
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="notice_view?bno=${map.prevDto.bno}">${map.prevDto.btitle}</a></td>
								</tr>
							</tbody>
						</table>
					</div>
							...
							$(document).on("click",".replyBtn",function(){
								...
								$.ajax({
									...
									success:function(data){
										...
										hdata+='<li class="name">'+data.id+' <span>['+data.cdate+']</span></li>';
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span class="orange cCount">${map.list.size()}</span> 개의 댓글이 달려있습니다.</p>
