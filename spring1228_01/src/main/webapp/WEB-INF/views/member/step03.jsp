...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="outbox">		
			...
			<!-- contents -->
			<form name="mFrm" method="post" action="step03">
			<div id="contents">
				<div id="member">
						...
						<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											<li class="r10"><input type="password" class="w134" name="pw2"/></li>
											<li>
								...
								<tr>
									...
									<td>
										<ul class="pta">
											...
											<li>&nbsp;<span class="valign">-</span>&nbsp;</li>
											<li><input type="text" class="w74" maxlength="4" name="m_phone"/> <span class="valign">-</span>&nbsp;</li>
											<li class="r10"><input type="text" class="w74" maxlength="4" name="l_phone"/></li>
